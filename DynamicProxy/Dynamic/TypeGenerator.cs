...
internal class TypeGenerator
{
    ...
    private readonly ConstructorInfo _attributeConstructor;
    ...
    private readonly MethodInfo _delegateCombine;
    ...
    public TypeGenerator(Type type, TypeBuilder builder)
    {
        ...
        _attributeConstructor = typeof(AutoGeneratedGuidAttribute)
        ...
        _delegateCombine = typeof(Delegate)
        ...
        EventInfo eventInfo)
    {
        ...
        {
            case 1:
                il.Emit(OpCodes.Call, _delegateCombine);
                break;
            case 2:
