...
public interface IMetadataService
{
    ...
    uint SerializationAck(ReadOnlySpan<byte> session, uint serialization);
    ...
    /// <returns></returns>
    IEnumerable<RpcMetadataServiceWrap> GetAvailableServices(ReadOnlySpan<byte> session,
    ...
    /// <returns></returns>
    IEnumerable<RpcMetadataTypeMappingWrap> GetAvailableTypes(ReadOnlySpan<byte> session,
    ...
    void ClientTypeEventAdvise(ReadOnlySpan<byte> session, IEnumerable<RpcMetadataEventWrap> events);
}